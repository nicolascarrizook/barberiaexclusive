...
export function ErrorFallback({ error, errorInfo, resetError, level = 'component' }: ErrorFallbackProps) {
  ...
  return (
    <div className={`flex items-center justify-center ${level === 'page' ? 'min-h-screen' : 'min-h-[400px]'} p-4`}>
