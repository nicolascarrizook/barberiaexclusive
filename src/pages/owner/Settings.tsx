    ...
    values: barbershop
      ? {
          ...
          min_advance_booking_hours:
            barbershop.settings?.min_advance_booking_hours || 2,
          max_advance_booking_days:
            barbershop.settings?.max_advance_booking_days || 60,
    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="general" className="space-y-6">
              ...
              <CardContent className="space-y-4">
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      type="number"
                      {...form.register('min_advance_booking_hours', {
                        valueAsNumber: true,
                      })}
                      disabled={isSubmitting}
                    />
                    <p className="text-sm text-muted-foreground">
                      Los clientes deben reservar con al menos estas horas de
                      anticipación
                    </p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      type="number"
                      {...form.register('max_advance_booking_days', {
                        valueAsNumber: true,
                      })}
                      disabled={isSubmitting}
                    />
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    type="number"
                    {...form.register('cancellation_hours', {
                      valueAsNumber: true,
                    })}
                    disabled={isSubmitting}
                  />
                  <p className="text-sm text-muted-foreground">
                    Los clientes pueden cancelar hasta estas horas antes de la
                    cita
                  </p>
                </div>
              </CardContent>
        ...
        <TabsContent value="holidays" className="space-y-6">
          {barbershop?.id && <HolidayCalendar barbershopId={barbershop.id} />}
        </TabsContent>
      </Tabs>
    </div>
  );
